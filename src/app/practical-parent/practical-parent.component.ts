...
@Component({
  selector: 'app-practical-parent',
  templateUrl: './practical-parent.component.html',
  styleUrls: ['./practical-parent.component.scss']
})
export class PracticalParentComponent implements OnInit {
